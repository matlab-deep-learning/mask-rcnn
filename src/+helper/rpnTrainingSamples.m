...
if isfield(params, 'GroundTruthMby4') && params.GroundTruthMby4
    ...
    groundTruthBoxes = vertcat(varargin{1});
end
...
[regionProposals, anchorLocInFeatureMap] = helper.generateAnchorBoxesInImage(...
...
[targets, positiveIndex, negativeIndex] = ...
    helper.BoundingBoxRegressionModel.generateRegressionTargetsFromProposals(...
